          ...
          <table :class="$style.stepsTable">
            <tbody>
              ...
              <tr>
                <td>Step 3:</td>
                <td>
                  Go through each cell, and mark whether a cell should be a room based on the 8
                  cells around it. <br />For example, cells with no rooms around them have a 0%
                  chance of being a room, cells with 1 room around them have a 90% chance of being a
                  room, etc...
                  <div :class="$style.thinSpacer"></div>
          ...
          <table :class="$style.stepsTable">
            <tbody>
              ...
              <tr>
                <td>Step 5:</td>
                <td>
                  Run a recursive traversal algorithm from the starting room, and mark every
                  reachable room.
                </td>
              </tr>
              <tr>
