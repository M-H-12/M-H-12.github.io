        ...
        <div :class="$style.bottomLeftSegment">
          <div :class="$style.sectionWidth">
            <div :class="$style.bodyText">
              ...
              developers to create a native app using the frontend framework of their choice, while
              at the same time providing a Rust backend to allow for system interaction.
              <br />
              <br />
      ...
      <div :class="$style.rightSegment">
        <div :class="$style.sectionWidth">
          <div :class="$style.bodyText">
            ...
            pixelated art style. The player would be placed in a dungeon, collect items in different
            rooms, and would eventually make their way to the boss room to finish the level.
            <br />
            <br />
