  ...
  <div class="main-segment-light" :style="{ top: `${pagePosition}vh` }">
    <div :class="$style.displayContainer">
      <div :class="$style.leftSegment">
        ...
        <div :class="currentShadowStyle" style="position: relative">
          <div :class="$style.bottomLeftSegment">
            <div :class="$style.sectionWidth">
              <div :class="$style.bodyText">
                ...
                developers to create a native app using the frontend framework of their choice,
                while at the same time providing a Rust backend to allow for system interaction.
                <br />
                <br />
        ...
        <div :class="$style.rightSegment">
          <div :class="$style.sectionWidth">
            <div :class="$style.bodyText">
              ...
              The main idea for the game was that it would be a simple dungeon-crawler with a
              pixelated art style. The player would be placed in a dungeon, collect items in
              different rooms, and would eventually make their way to the boss room to finish the
              level.
              <br />
              <br />
              As time went on, I started to add in more details regarding how the game should
              function. I wanted the dungeons to be randomly generated, but I also wanted the player
              to have some input into each level. This idea would go on to shape the game's start,
              where the player is asked random questions, and their answers affect the dungeon's
              features.
              <br />
              <br />
              Because level design would be the most important part of my game, I decided to start
              on the dungeon generation algorithm, and work my way forwards from there.
            </div>
          </div>
        </div>
      </div>
