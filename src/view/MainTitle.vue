 ...
 */
const { pagePosition, currentShadowStyle } = storeToRefs(scrollUtil)
...
<template>
  ...
  >
    <div :class="currentShadowStyle" style="z-index: 2">
    ...
    <div :class="[$style.mainSegment, currentShadowStyle]"></div>
  </div>
</template>
