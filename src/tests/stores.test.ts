...
it('Scrolling up on the project info screen results in the title screen', async () => {
...
it('Swiping down on the project info screen (mobile) results in the title screen', async () => {
  const globalVariables = useGlobalVariables()
